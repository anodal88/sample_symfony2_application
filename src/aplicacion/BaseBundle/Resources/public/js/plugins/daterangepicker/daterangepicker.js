...
!function ($) {
        ...
        var DRPTemplate = '<div class="daterangepicker dropdown-menu">' +
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    ...
                    '</div>' +
                    '<button id="stats" class="' + this.applyClass + ' applyBtn" disabled="disabled">' + this.locale.applyLabel + '</button>&nbsp;' +
    ...
    DateRangePicker.prototype = {
        ...
        clickApply: function (e) {
            ...
            /*codigo para validar el rango de tiempo*/
            //var rango = $("#fechaferiado").val();
            if(Date.parse(this.startDate) >= Date.parse(this.endDate))
                {
                     alert('Error de rango, la fecha y hora final deben ser superior al inicial.')
                }
                else
                    {
                        this.updateInputText();
