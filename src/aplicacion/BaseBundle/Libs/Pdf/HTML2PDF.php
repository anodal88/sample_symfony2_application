 ...
 * @version 4.03
 */
namespace aplicacion\BaseBundle\Libs\Pdf;

use aplicacion\BaseBundle\Libs\Pdf\clases\HTML2PDF_locale;
use aplicacion\BaseBundle\Libs\Pdf\clases\HTML2PDF_exception;
use aplicacion\BaseBundle\Libs\Pdf\clases\HTML2PDF_myPdf;
use aplicacion\BaseBundle\Libs\Pdf\clases\HTML2PDF_parsingHtml;
use aplicacion\BaseBundle\Libs\Pdf\clases\HTML2PDF_parsingCss;
...
if (!defined('__CLASS_HTML2PDF__')) {
    ...
    require_once(dirname(__FILE__).'/clases/HTML2PDF_exception.php');
    require_once(dirname(__FILE__).'/clases/HTML2PDF_locale.php');
    require_once(dirname(__FILE__).'/clases/HTML2PDF_myPdf.php');
    require_once(dirname(__FILE__).'/clases/HTML2PDF_parsingHtml.php');
    require_once(dirname(__FILE__).'/clases/HTML2PDF_parsingCss.php');
